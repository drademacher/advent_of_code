...
With simple cases that don't consume too much of your time and year2023.resources that can be almost unnoticeable, but when the solution takes seconds, it is worth considering breaking the daily solution into two separated pieces, like `Day07_part1.kt` and `Day07_part2.kt`.
...
If you are stuck with Kotlin-specific questions or anything related to this template, check out the following year2023.resources:
